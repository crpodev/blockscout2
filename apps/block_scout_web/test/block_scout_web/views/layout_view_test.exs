defmodule BlockScoutWeb.LayoutViewTest do
  ...
  describe "network_title/0" do
    ...
    test "use the default network title when there is no env configured for it" do
      assert LayoutView.network_title() == "eRon"
    end
  end
  ...
  @supported_chains_pattern ~s([ { "title": "RSK", "url": "https://blockscout.com/rsk/mainnet", "other?": true }, { "title": "Sokol", "url": "https://blockscout.com/poa/sokol", "test_net?": true }, { "title": "eRon", "url": "https://blockscout.com/poa/core" }, { "title": "LUKSO L14", "url": "https://blockscout.com/lukso/l14", "test_net?": true, "hide_in_dropdown?": true } ])
